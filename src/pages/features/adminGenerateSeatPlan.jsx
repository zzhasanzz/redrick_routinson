import { Box, SimpleGrid, Button, Text, Spinner, Input, HStack, IconButton, useToast } from "@chakra-ui/react";
...
const GenerateSeatPlan = () => {
    ...
    const handleDeleteRoom = async () => {
        ...
        try {
            ...
            toast({ title: "Room deleted successfully!", status: "success", duration: 3000, isClosable: true });
        } catch (error) {
