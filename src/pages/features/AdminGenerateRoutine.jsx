...
const AdminGenerateRoutine = () => {
      ...
      <Box overflowX="auto" mb={8}>
        <Table variant="striped" border="black" colorScheme="white" size="xl">
          <Thead bg="rgb(43, 65, 98)">
            <Tr>
              <Th width="15%" textAlign="center" color="rgb(43, 41, 41)">Day</Th>
          ...
          <Tbody>
            {days.map((day, dayIndex) => {
              ...
              return (
                <Tr key={dayIndex}>
                  <Td fontWeight="600" textAlign="center" bg={useColorModeValue('white', 'gray.800')}>
                    {day}
                  </Td>
  ...
  if (loading) {
    return (
      <Box textAlign="center" p={8}>
        <Spinner size="xl" />
        <Text mt={4} fontSize="lg">Loading timetable data...</Text>
      </Box>
    );
  }
  ...
  return (
    <Box p={6}>
      <Heading mb={6} color="rgb(43, 65, 98)">Routine for All Ongoing Semesters</Heading>
                ...
                <TabPanels mt={4}>
                  <TabPanel p={2}>
                    {timetableData[semester]?.A ?
                      ...
                      <Text textAlign="center" p={4}>No data for Section A</Text>
                    }
                  </TabPanel>
                  <TabPanel p={2}>
                    {timetableData[semester]?.B ?
                      renderSectionTable(timetableData[semester].B) :
                      <Text textAlign="center" p={4}>No data for Section B</Text>
                    }
                  </TabPanel>
                </TabPanels>
              </Tabs>
